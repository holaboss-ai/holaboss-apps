...
function createMcpServer(): McpServer {
  ...
  server.tool("linkedin_create_post", "Create a new LinkedIn post draft (max 3000 chars)", {
    content: z.string().max(3000).describe("Post content (max 3000 characters)"),
  ...
  server.tool("linkedin_update_post", "Update a draft LinkedIn post", {
  ...
  server.tool("linkedin_list_posts", "List LinkedIn posts", {
  ...
  server.tool("linkedin_get_post", "Get a specific LinkedIn post by ID", {
    post_id: z.string().describe("Post ID"),
  }, async ({ post_id }) => {
    const db = getDb()
  ...
  server.tool("linkedin_publish_post", "Publish a LinkedIn post immediately or schedule it", {
  ...
  server.tool("linkedin_get_publish_status", "Check publish status of a LinkedIn post", {
    post_id: z.string().describe("Post ID"),
  }, async ({ post_id }) => {
    const db = getDb()
  ...
  server.tool("linkedin_cancel_publish", "Cancel a scheduled LinkedIn post", {
  ...
  server.tool("linkedin_delete_post", "Delete a LinkedIn post draft. Only draft or failed posts can be deleted.", {
  ...
  server.tool("linkedin_get_queue_stats", "Get LinkedIn publish queue statistics", {}, async () => {
