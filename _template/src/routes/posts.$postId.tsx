  ...
  return (
    <div className="mx-auto max-w-2xl p-6">
      ...
      <textarea
        ...
        className="border-border bg-card focus:ring-ring w-full resize-none rounded-lg border p-4 text-sm leading-relaxed focus:ring-2 focus:outline-none"
        rows={6}
        maxLength={280}
        autoFocus
      />
      <div className="mt-1 flex items-center justify-between">
        <span
          className={`text-xs ${content.length > 260 ? "text-destructive" : "text-muted-foreground"}`}
        >
          {content.length}/280
        </span>
      </div>
